...
export const metadata: Metadata = {
  title: "PulseScope — Veille marche automatisee, briefing Slack chaque matin",
  description: "Vos concurrents analyses, synthese IA deposee dans votre Slack a 8h. 15h/semaine economisees.",
};
